...
void p(sf::Event& event, Player& currentPlayer, std::vector<Player>& Player, int& selectedCardIndex, std::vector<int>& selected_Card, bool& cardTaken, int& selectedButtonIndex, bool& showMessageEscape, bool& showCardSelectionMessage, bool& canSelectCards, bool& canTakeCard, bool& returnToMenu, int& selectedCardIndexRight, int& neighborIndex, sf::RenderWindow& windowss, sf::Text& message_ispair, int& playersChoseNo, bool& showMessageWait, int& shift)
{
...
// // Функция для обработки событий клавиатуры для человека
// void handleHumanKeyPress(sf::Event& event, Player& currentPlayer, std::vector<Player>& Player, int& selectedCardIndex, std::vector<int>& selected_Card, bool& cardTaken, int& selectedButtonIndex, bool& showMessageEscape, bool& showCardSelectionMessage, bool& canSelectCards, bool& canTakeCard, bool& returnToMenu, int& selectedCardIndexRight, int& neighborIndex, sf::RenderWindow& windowss, sf::Text& message_ispair, int& playersChoseNo, bool& showMessageWait, int& shift) override {
//     // Здесь логика обработки нажатий клавиш для игрока-человека
...
// Функция для обработки событий клавиатуры для бота
void handleBotKeyPress(sf::Event& event, Player& currentPlayer, std::vector<Player>& players, int& selectedCardIndex, std::vector<int>& selected_Card, bool& cardTaken, int& selectedButtonIndex, bool& showMessageEscape, bool& showCardSelectionMessage, bool& canSelectCards, bool& canTakeCard, bool& returnToMenu) {
    // Здесь логика обработки нажатий клавиш для игрока-бота
    // ...
}
